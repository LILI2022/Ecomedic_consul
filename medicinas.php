...
<head>
    ...
    <title>medicinas | Ecomedica</title>
        ...
        <div class="col-12">
            <div class="card mb-5">
                <div class="card-header"  style="background: #00ffc02b;">
                     ...
                     <button type='button' class="btn btn-success" data-toggle="modal" onclick="NuevoMedicina();" >
...
$(document).ready(function(){
    listar('ajax/listar_medicinas.php');
    //prueba();
});
function listar(url){
    $.ajax({
...
function NuevoMedicina(){
    MostrarModal(0, 'modal/nuevo_medicinas.php');
}
function eliminarUsuario(id){
  if(confirm("Está seguro de eliminar el registro?")){
        $.ajax({
            type:'POST',
            url:'ajax/grabar_medicinas.php',
            data:{
                id_p:id,
                mensaje:'eliminar'
            },
...
function editarUsuario(id){
    //alert(id);
    MostrarModal(id, 'modal/nuevo_medicinas.php');
}
...
//    var idCanton=$('#canton').val();
    var parametro="Hola";
    VentanaCentrada('./pdf/documentos/reportemedicina.php?prueba_p='+parametro,'Reporte_Usuario','','1024','768','true');
}
</script>
